...
$(document).ready(function()
{
  ...
  {
    $(this).attr("src", themeUri + "system/win_controls/min_dep.png");
    $(this).mouseup(function()
    {
      $(this).attr("src", themeUri + "system/win_controls/min.png");
  ...
  // MAXIMIZE BUTTON
    ...
    {
      $(this).attr("src", themeUri + "system/win_controls/max_dep.png");
      $(this).mouseup(function()
      {
        $(this).attr("src", themeUri + "system/win_controls/max.png");
        var windc_id = $(this).parent().attr("id");
        var windc_id_splt = windc_id.split("_");
        var win_id = windc_id_splt[2];
        var window_id = "#window_" + win_id;
