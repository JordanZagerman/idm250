...
function makeWindow(themeUri ,icon, title, frameurl, taskbar, res, wid, hei) { /* IT WORKS!!! What's the catch? */
	window_set++;
    ...
    if(res != false && taskbar != false) { // all buttons
		var sec7 = '"><img src=" '+themeUri+' system/win_controls/min.png" class="win_titb_min" id"_"><img src="system/win_controls/max.png" class="win_titb_max" id"_"><img src="system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
		...
		var sec7 = '"><img src="'+themeUri+'system/win_controls/min.png" class="win_titb_min" id"_"><img src="'+themeUri+'system/win_controls/max_disabled.png" class="win_titb_max_dis" id"_"><img src="system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
	} else if (taskbar == false) { // no minimize button
		var sec7 = '"><img src="'+themeUri+'system/win_controls/max.png" class="win_titb_max" id"_"><img src="system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
	}
