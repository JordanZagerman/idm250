...
<body onload="updateClock(); setInterval('updateClock()', 1000 );">
	...
	<div id="win_container">
		...
		<div class="icon_container">
			...
			<div class='homescreen_icons' onclick="makeWindow('<?php echo get_stylesheet_directory_uri(); ?>/dist/ ,<?php echo get_stylesheet_directory_uri(); ?>/dist/system/icons/document_file.png', 'README.txt', '<?php echo get_stylesheet_directory_uri(); ?>/pages/information_page.html', true);">
			...
			<div class='homescreen_icons' onclick="makeWindow('<?php echo get_stylesheet_directory_uri(); ?>/dist/ ,<?php echo get_stylesheet_directory_uri(); ?>/dist/system/icons/document_file.png', 'Portfolio', '<?php echo get_stylesheet_directory_uri(); ?>/pages/portfolio_index.html', true);">
			...
			<div class='homescreen_icons' onclick="makeWindow('<?php echo get_stylesheet_directory_uri(); ?>/dist/ ,<?php echo get_stylesheet_directory_uri(); ?>/dist/system/icons/recycle_bin_full.png', 'Recycle Bin', '<?php echo get_stylesheet_directory_uri(); ?>/pages/archive_page.html', true);">
			...
			<div class='homescreen_icons' onclick="makeWindow('<?php echo get_stylesheet_directory_uri(); ?>/dist/ ,<?php echo get_stylesheet_directory_uri(); ?>/dist/system/icons/contact_icon.png', 'Contact', '<?php echo get_stylesheet_directory_uri(); ?>/pages/contact_page.html', true);">
